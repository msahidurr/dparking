        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    {{ __('application.country.add_country') }}
                    @can("countries.index")
                    <a class="btn btn-sm btn-primary pull-right" href="{{ route('countries.index') }}">{{
                        __('application.country.country_list') }}</a>
                    @endcan
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required
                                        ...
                                        value="{{ old('short_code') }}" name="short_code">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required
                                        ...
                                        value="{{ old('phone_code') }}" name="phone_code">
                            ...
                            <div class="col-12">
                                <div class="pull-right d-flex justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        {{ __('application.country.create_new') }}
                                    </button>
                                </div>
                            </div>
                        </div>
