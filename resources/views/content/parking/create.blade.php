                ...
                <div class="card-body p-2">
                    <form action="{{ route('parking.quick_end') }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input value="{{__('application.parking.find')}}"
                                    class="btn btn-sm btn-outline-info pull-right mt-2" type="submit">
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select id="agent_id" type="text"
                                                class="select2 form-control {{ $errors->has('agent_id') ? ' is-invalid' : '' }}"
